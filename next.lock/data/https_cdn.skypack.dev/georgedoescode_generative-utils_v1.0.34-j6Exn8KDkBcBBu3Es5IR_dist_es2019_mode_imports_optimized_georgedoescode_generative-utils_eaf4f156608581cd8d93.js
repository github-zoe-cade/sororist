...
var no = Object.getPrototypeOf, ro = Object.prototype.hasOwnProperty;
...
var oo = (t2, e, n) => {
  ...
  return t2;
}, sn = (t2) => oo(io(on(t2 != null ? Ji(no(t2)) : {}, "default", t2 && t2.__esModule && "default" in t2 ? {get: () => t2.default, enumerable: true} : {value: t2, enumerable: true})), t2);
var Rn = U((zn, an) => {
  (function(t2, e, n) {
    function r(o) {
      var l = this, f = a();
  ...
  (function(t2, e, n) {
    function r(a) {
      ...
      function l(f, u) {
        ...
        for (c = 0; c < 8 && p[c] === 0; ++c)
          ;
        for (c == 8 ? p[7] = -1 : p[c], f.x = p, f.i = 0, c = 256; c > 0; --c)
          f.next();
      }
      l(o, a);
    }
...
var Wn = U((Zn, ve) => {
  (function(t2, e, n) {
    ...
    function h(y, w, T) {
      ...
      var C = x(m(w.entropy ? [y, b(e)] : y != null ? y : _(), 3), A), S = new p(A), N = function() {
...
function po(t2, e, n, r = 0.5) {
  let i = At(t2, e), s = At(0, 1) * r;
  return i * (1 - s) + n * s;
}
function mo(t2, e, n) {
  return Math.round(At(t2, e) / n) * n;
}
function go(t2, e) {
...
function vo(t2, e, n, r, i) {
  return (t2 - e) / (n - e) * (i - r) + r;
}
function _o(t2, e = 10) {
  let n = t2.getTotalLength(), r = n / e, i = [];
  for (let s = 0; s < n; s += r)
    i.push(t2.getPointAtLength(s));
  return i;
}
function yo(t2) {
  let e = t2.createSVGPoint();
  return function(n) {
    return e.x = n.clientX, e.y = n.clientY, e.matrixTransform(t2.getScreenCTM().inverse());
  };
}
var nr = sn(er()), wo = {width: 1024, height: 1024, points: [], gap: 0, maxQtObjects: 10, maxQtLevels: 4};
function bo(t2, e, n) {
  return {col: {start: t2.x / e, end: (t2.x + t2.width) / e}, row: {start: t2.y / n, end: (t2.y + t2.height) / n}};
}
function jo(t2) {
  let e = [];
  return function n(r) {
    r.nodes.length === 0 ? e.push(r) : r.nodes.forEach((i) => n(i));
  }(t2), e;
}
function Mo(t2) {
  t2 = Object.assign({}, wo, t2);
  let e = new nr.default({x: 0, y: 0, width: t2.width, height: t2.height}, t2.maxQtObjects, t2.maxQtLevels);
  t2.points.forEach((s) => {
    e.insert(s);
  });
  let n = Math.pow(2, t2.maxQtLevels), r = t2.width / n, i = t2.height / n;
  return {width: t2.width, height: t2.height, cols: n, rows: n, areas: jo(e).map(({bounds: s}) => ({x: s.x + t2.gap, y: s.y + t2.gap, width: s.width - t2.gap * 2, height: s.height - t2.gap * 2, ...bo(s, r, i)}))};
}
function rr(t2) {
  return t2 * t2;
}
...
var q = 11102230246251565e-32, R = 134217729, Kt = (3 + 8 * q) * q;
...
var ko = (3 + 16 * q) * q, To = (2 + 12 * q) * q, Io = (9 + 64 * q) * q * q, Nt = g(4), ir = g(8), or = g(12), sr = g(16), H = g(4);
...
var lr = Math.pow(2, -52), we = new Uint32Array(512), Tt = class {
...
var xn = cr;
var Me = "http://www.w3.org/1999/xhtml", vn = {svg: "http://www.w3.org/2000/svg", xhtml: Me, xlink: "http://www.w3.org/1999/xlink", xml: "http://www.w3.org/XML/1998/namespace", xmlns: "http://www.w3.org/2000/xmlns/"};
function it(t2) {
...
function Nr(t2, e, n) {
  return arguments.length > 1 ? this.each((e == null ? ms : typeof e == "function" ? xs : gs)(t2, e, n != null ? n : "")) : ct(this.node(), t2);
}
function ct(t2, e) {
...
function Xt(t2, e, n, r) {
  return arguments.length === 1 ? Ws(t2) : new $(t2, e, n, r != null ? r : 1);
}
function $(t2, e, n, r) {
...
function ai(t2, e, n, r) {
  return arguments.length === 1 ? si(t2) : new J(t2, e, n, r != null ? r : 1);
}
function J(t2, e, n, r) {
...
var kn = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Tn = new RegExp(kn.source, "g");
function ra(t2) {
  return function() {
    return t2;
  };
...
var hi = 180 / Math.PI, Pe = {translateX: 0, translateY: 0, rotate: 0, skewX: 0, scaleX: 1, scaleY: 1};
...
var Cn = mi(pi, "px, ", "px)", "deg)"), En = mi(di, ", ", ")", ")");
var zt = 0, oe = 0, se = 0, gi = 1e3, qe, ae, Xe = 0, Et = 0, ze = 0, le = typeof performance == "object" && performance.now ? performance : Date, xi = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t2) {
  setTimeout(t2, 17);
};
function ue() {
...
var la = xn("start", "end", "cancel", "interrupt"), ua = [], yi = 0, wi = 1, Fe = 2, Le = 3, bi = 4, Ve = 5, fe = 6;
...
function Bi(t2, e, n) {
  ...
  if (typeof e != "function")
    throw new Error();
  return this.tween(r, za(t2, e, n != null ? n : ""));
}
function Ra(t2) {
  return function() {
    this.textContent = t2;
...
function Qi(t2) {
  t2 = Object.assign({}, $a, t2), t2.points = t2.points.map((i) => [i.x, i.y]);
  let e = St.from(t2.points), n = e.voronoi([0, 0, t2.width, t2.height]);
  for (let i = 0; i < t2.relaxIterations; i++) {
    for (let s = 0; s < e.points.length; s += 2) {
      let a = n.cellPolygon(s >> 1);
      if (a === null)
        continue;
      let o = e.points[s], l = e.points[s + 1], [f, u] = Bt(a);
      e.points[s] = o + (f - o) * 1, e.points[s + 1] = l + (u - l) * 1;
    }
    n.update();
  }
  let r = [];
  for (let i = 0; i < e.points.length; i += 2) {
    let s = n.cellPolygon(i >> 1);
    s !== null && r.push({...Ui(s), neighbors: [...n.neighbors(i)].map((a) => ({...Ui(n.cellPolygon(a))}))});
  }
  return {cells: r.map((i, s) => {
    let a = [...n.neighbors(s)];
    return i.neighbors = a.map((o) => r[o]), i;
  })};
}
function Ui(t2) {
...
var Zi = sn(Ki()), Ka = {width: 200, height: 200, resolution: 8, xInc: 0.01, yInc: 0.01, seed: Math.random() * 1e3};
function Wi(t2, e, n) {
  return Math.max(e, Math.min(t2, n));
}
function Za(t2, e, n, r, i) {
  return function(s) {
    let a = Math.floor(Wi(s.x, 0, e - 1) / i), o = Math.floor(Wi(s.y, 0, n - 1) / i);
    return t2[a + o * r];
  };
}
function Wa(t2) {
  t2 = Object.assign({}, Ka, t2);
  let e = new Zi.default(t2.seed), n = t2.resolution, r = t2.resolution, i = t2.width / n, s = t2.height / r, a = new Array(n * r), o = 0;
  for (let l = 0; l < t2.height; l += s) {
    let f = 0;
    for (let u = 0; u < t2.width; u += i)
      Math.floor(u + i) <= t2.width && Math.floor(l + s) <= t2.height && (a[Math.round(u / i + l / s * n)] = {x: u, y: l, width: i, height: s, noiseValue: e.noise2D(f, o)}, f += t2.xInc);
    o += t2.yInc;
  }
  return {cells: a, lookup: Za(a, t2.width, t2.height, n, i)};
}
/**
* quadtree-js
* @version 1.2.4
...
*/
export {yo as createCoordsTransformer, Wa as createNoiseGrid, Mo as createQtGrid, Qi as createVoronoiDiagram, Qi as createVoronoiTessellation, ye as distToSegment, vo as map, _o as pointsInPath, At as random, po as randomBias, mo as randomSnap, ho as seedPRNG, xo as spline};
export default null;
