...
function x$2(x2, box = this.bbox()) {
  if (x2 == null) {
    return box.x;
  }
  return this.attr("x", this.attr("x") + x2 - box.x);
}
function y$2(y2, box = this.bbox()) {
  if (y2 == null) {
    return box.y;
  }
...
function cx$1(x2, box = this.bbox()) {
  if (x2 == null) {
    return box.cx;
  }
  return this.attr("x", this.attr("x") + x2 - box.cx);
}
function cy$1(y2, box = this.bbox()) {
  if (y2 == null) {
    return box.cy;
  }
...
function height$2(height2, box = this.bbox()) {
  if (height2 == null)
    return box.height;
  return this.size(box.width, height2, box);
}
function move$2(x2 = 0, y2 = 0, box = this.bbox()) {
  const dx2 = x2 - box.x;
  const dy2 = y2 - box.y;
  return this.dmove(dx2, dy2);
}
function size$1(width2, height2, box = this.bbox()) {
...
function width$2(width2, box = this.bbox()) {
  if (width2 == null)
    return box.width;
  return this.size(width2, box.height, box);
}
function x$3(x2, box = this.bbox()) {
  if (x2 == null)
    return box.x;
  return this.move(x2, box.y, box);
}
function y$3(y2, box = this.bbox()) {
  if (y2 == null)
    return box.y;
